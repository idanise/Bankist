...
const account1 = {
  ...
  movementsDates: [
    '2022-03-22T21:31:17.178Z',
    '2022-03-18T07:42:02.383Z',
    '2021-12-28T09:15:04.904Z',
    '2022-03-01T10:17:24.185Z',
    '2021-12-31T14:11:59.604Z',
...
const displayMovments = function (acc, sort = false) {
  ...
  movs.forEach(function (mov, i) {
    ...
    `
    //Adds elements to the movement container
...
labelBalance.addEventListener('click', function () {
  ;[...document.querySelectorAll('.movements__row')].forEach(function (row, i) {
    ...
    if (i % 3 === 0) row.style.backgroundColor = 'wheat'
  })
})
